...
To train or test on custom datasets, put the volumes under `data/OCTA/[custom volume folders]`. (Optional) Put the indices (separated by spaces) of estimated corrupted B-scans in `data/OCTA/[volume folder name]_BMA_index.txt`.
