# calculate and visualize CNR and MSR of corrupted B-scans
import cv2
import os
import numpy as np
...
if not os.path.exists('mark_cnr_msr_corrupted'):
    os.mkdir('mark_cnr_msr_corrupted')

for exp_name in exp_names:
    mark_root = os.path.join('mark_cnr_msr_corrupted', exp_name)
    ...
    for v in Volumes:
        ...
        label_dir = os.path.join(label_root, v + '_corrupted')

        mark_dir = os.path.join('mark_cnr_msr_corrupted', os.path.join(exp_name, v))
